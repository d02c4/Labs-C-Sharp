...
namespace Lib
{
    ...
    public class Person : IExecutable, IComparable, ICloneable
    {
        ...
        protected static string[] nameA = { "Александр", "Алексей", "Анатолий", "Андрей", "Антон", "Аркадий", "Арсений", "Артём", "Артур", "Борис", "Вадим", "Валентин", "Валерий", "Василий", "Виктор", "Виталий", "Владимир", "Владислав", "Вячеслав", "Георгий", "Глеб", "Григорий", "Даниил", "Денис", "Дмитрий", "Евгений", "Егор", "Иван", "Игорь", "Илья", "Кирилл", "Константин", "Лев", "Леонид", "Максим", "Марк", "Матвей", "Михаил", "Никита", "Николай", "Олег", "Павел", "Пётр", "Роман", "Руслан", "Сергей", "Степан", "Тимур", "Фёдор", "Юрий", "Ярослав" };
        protected static string[] surnameA = { "Пантелеев", "Чувашев", "Галинов", "Ананина", "Масылюк", "Вострокнутова", "Сабуров", "Исламов", "Шамай", "Филатов", "Сафронов", "Шарпов", "Карелов", "Брейкин", "Копытов", "Солдатов", "Кузнецов", "Пажгин", "Фотин", "Бадретдинов", "Механошин", "Булдаков", "Тулинов", "Тедеев", "Колпаков", "Черных", "Нефедов", "Рябцев", "Пепеляев", "Тарасов", "Аркадьев" };
        protected static string[] nameSchoolA = { "37 школа", "1 лицей", "2 лицей", "38 школа", "1 гимназия" };
        protected static string[] nameUniverA = { "ПНИПУ", "ПГНИУ", "ВятГУ", "КубГУ", "ПГУ", "МГУ", "МФТИ", "РАНХиГС" };
        protected static string[] nameGroupA = { "ИВТ-20-2б", "ИВТ-20-1б", "РИС-20-1б", "РИС-20-2б", "АСУ-19", "АСУ-18", "КС-19", "КС-18" };
        protected static string[] sexA = { "Man", "Woman" };
