...
namespace Lab_16_1
{
    public partial class ActionPerson : Form
    {
        bool mode = false; 
        ...
        public ActionPerson(bool mode, ref NewMyCollection<Person> collection, int ind, Form1 form1)
        {
            this.form1 = form1;
            this.mode = mode;
        ...
        private void ActionPerson_Load(object sender, EventArgs e)
        {
            ChangeMode();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Person person = new Person(textBoxName.Text, textBoxSurname.Text, int.Parse(textBoxAge.Text), textBoxSex.Text, double.Parse(textBoxAVG.Text));
