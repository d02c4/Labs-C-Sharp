...
namespace TestSchoolboy
{
    ...
    public class UnitTest1
    {
        ...
        public void TestClone()
        {
            ...
            Assert.AreEqual(schoolboy1, schoolboy);
        }
        ...
        {
            Schoolboy schoolboy = new Schoolboy("Aboba", "Aloha", 12, "M", 4.2, "Sharaga", 9);
            Schoolboy schoolboy1 = (Schoolboy)schoolboy.ShallowClone();
            Assert.AreEqual(schoolboy1, schoolboy);
        }
        ...
        {
            Schoolboy schoolboy = new Schoolboy("Aboba", "Aloha", 12, "M", 4.2, "Sharaga", 9);
            string str = schoolboy.ToString();
            Assert.AreEqual(str, "Aboba Aloha 12 M 4,2 9 Sharaga");
        }
